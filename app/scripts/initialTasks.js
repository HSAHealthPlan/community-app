        ...
        jQuery.ajax("/config.json", { async: false, cache: false })
            .done(function (data) {
                ...
                if (response) {
                    ...
                    alert('Unable to parse the server configuration data');
                    throw Error("Error parsing config.json");
                }
                ...
                //accessing from a file system or other servers
                    ...
                    if (mainLink.hostname != "") {
                        baseApiUrl = config.baseApiUrl || "https://" + mainLink.hostname + (mainLink.port ? ':' + mainLink.port : '');
                    }
            ...
            .fail(function () {
                alert('Unable to retrieve config.json from server');
            })
    };
